...
//Devo equilibrare il sistema prima di fare le misure di valori istantanei da utilizzare
//nello script python. Quindi faccio la prima run (con blocchi di lunghezza 1, per evitare
//di fare un altro output di valori istantanei) fino a equilibrazione (verificata). Poi
//comincio la nuova run dalla configurazione finale della run precedente e finalmente
//(lo faccio manualmente da riga di compando con cp)utilizzo i valori istantanei salvati
...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    stima_pot = blk_av[iv]/blk_norm/(double)npart + vtail; //Potential energy. Valore medio nel blocco.
